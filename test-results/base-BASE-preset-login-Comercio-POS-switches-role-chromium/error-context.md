...
Locator: locator('text=Terminal POS Comercio')
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" locator('text=Terminal POS Comercio') with timeout 10000ms
  - waiting for locator('text=Terminal POS Comercio')
